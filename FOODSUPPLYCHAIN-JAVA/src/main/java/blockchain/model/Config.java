...
public class Config {
	...
	private Config() {
		...
		try {
			...
			defaultProperty(ORGS + "peerManufacturer.mspid", "ManufacturerMSP");
			defaultProperty(ORGS + "peerManufacturer.domname", "manufacturer.supplychain.com");
			defaultProperty(ORGS + "peerManufacturer.ca_location", "http://localhost:7054");
			defaultProperty(ORGS + "peerManufacturer.peer_locations", "peer0.manufacturer.supplychain.com@grpc://localhost:7051, peer0.middlemen.supplychain.com@grpc://localhost:8051");
			defaultProperty(ORGS + "peerManufacturer.orderer_locations", "orderer.supplychain.com@grpc://localhost:7050");
			defaultProperty(ORGS + "peerManufacturer.eventhub_locations", "peer0.manufacturer.supplychain.com@grpc://localhost:7053, peer0.middlemen.supplychain.com@grpc://localhost:8053");
